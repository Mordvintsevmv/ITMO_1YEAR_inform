...
lz = LZEncoder()
print(lz.decode(lz.encode("Python is a widely used high-level programming language for general-purpose programming, created by Guido van Rossum and first released in 1991.")))

print(Encoder.getCompressionCoef(lz))
print(Encoder.getCompressionCoef(huff))